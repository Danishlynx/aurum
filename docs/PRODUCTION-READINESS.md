...
| Face shape | gated with honest copy | `faceAttributes` unverified. `/hair` reads the null shape and says so, and offers the unknown shape style set rather than guessing. |
