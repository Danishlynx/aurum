...
The bad frame categories (dark, over exposed, off center, partial face, no face, turned away, eyes closed, two faces) have no photo folder. They are covered by the synthetic frames eval:capture builds itself and by the exported outcome rows under evals/fixtures/private (below), where the engine's own refusals name what the gate missed. A photo of a printed photo is not a category the gate claims to catch.
